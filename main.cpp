...
float lower_pid_d = 0;
///////////////////////////////ROLL PID CONSTANTS////////////////////
double lower_kp = 1.0; //3.55
double lower_ki = 0.042; //0.003
double lower_kd = 0.025; //2.05
...
void loop() {
  ...
  /*///////////////////////////P I D///////////////////////////////////*/
  lower_desired_angle = -5;   //The angle we want the gimbal to stay is 0 and 0 for both axis for now...
